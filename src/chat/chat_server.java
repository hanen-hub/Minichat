...
public class chat_server extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        String msgin="" ; 
        try {
            ss = new ServerSocket(1301) ; //creation d'un serveur 
            s=ss.accept() ;  //un client se connecte directement ilya genenration dun socket  
            din= new DataInputStream(s.getInputStream()); // lire des donnees envoyer par le client 
            dout =new  DataOutputStream(s.getOutputStream()); // envoyer la reponse 
           
            while (!msgin.equals("exit")){
                msgin=din.readUTF() ; 
                msg_area.setText(msg_area.getText() + "\n " + msgin) ; // displaying tha msg  ; 
